...
import img from"../../assets/img/header/female_shop.jpg"
function Header() {
  return (
    <>
      <header>
        <div className="global-notification">
          <div className="container">
            <p>
              TÜM ÜRÜNLERDE %50 &apos;YE VARAN İNDİRİMLERİ KAÇIRMA! &nbsp; 
